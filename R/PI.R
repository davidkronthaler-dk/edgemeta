################################################################################
# Title: PI.R                                                                  #
# Description: contains methods to compute prediction intervals for random-    #
...
PredDist <- function(es, se, method = c("FixedTau2", "SimplifiedCD", "FullCD"),
...
pd_cd_tau2 <- function(es, se, lpi = 0.95, theta_new = NULL,
  ...
  ## Initial steps: needed for AQ and for MC integration
  ##----------------------------------------------------------------------------
